...
class VirtualDisplayController {
  ...
  public static VirtualDisplayController create(
    ...
    Log.e(TAG, "create densityDpi: " + densityDpi);
            ...
            OneTimeOnDrawListener.schedule(
                ...
                new Runnable() {
                  ...
                  public void run() {
                    ...
                    // more responsive
                    // following a resize.
                    Log.e(TAG, "onNewSizeFrameAvailable::");
  ...
  //Android 31 以上，Presentation 的实现 在全屏旋转时会导致 BufferQueue has no connected producer。
  //推测是 VirtualDisplay 重新创建导致的 之前的 Surface 被回收了。在这里直接调用 resize 方法，不重新创建。
